  ...
  return (
    <>
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 20 }}>
        <h1 style={{ fontSize: 24, fontWeight: 700, color: "#111827", margin: 0 }}>Monitoring Dashboard</h1>
  ...
  return (
    <>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, marginBottom: 20 }}>
        {/* Model Distribution */}
        <div style={{ ...cardStyle, padding: 20 }}>
          <div style={{ fontSize: 15, fontWeight: 600, color: "#111827", marginBottom: 16 }}>Model Distribution (Last 7 Days Top 10)</div>
          <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
            {mounted && modelDist.length > 0 ? (
              <>
                <ResponsiveContainer width={180} height={180}>
                  <PieChart>
                    ...
                    <Tooltip
                      contentStyle={{ borderRadius: 8, border: "1px solid #e5e7eb", fontSize: 12 }}
                      formatter={(value: any) => [Number(value).toLocaleString() + " calls", "Requests"]}
                    />
                  </PieChart>
                </ResponsiveContainer>
              ...
              <div style={{ width: "100%", textAlign: "center", color: "#9ca3af", padding: 40, fontSize: 13 }}>No data</div>
            )}
          </div>
        </div>
      ...
      <div style={{ ...cardStyle, padding: 20 }}>
        ...
        {topUsers.length > 0 ? (
          ...
          <div style={{ textAlign: "center", color: "#9ca3af", padding: 40, fontSize: 13 }}>No user data</div>
        )}
      </div>
