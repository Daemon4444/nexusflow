...
const params = [
  { name: "model", type: "string", required: true, desc: "模型名称，如 qwen3.8-max、qwen3.7-plus、qwen3.7-max 等" },
    ...
    <div style={{ padding: "48px 64px", maxWidth: 1000 }}>
      ...
      <section style={{ marginBottom: 36 }}>
        ...
        <p style={{ fontSize: 14, color: "var(--text-secondary)", lineHeight: 1.8 }}>
          当前 Responses API 严格跟随百炼官方白名单，支持相应 Qwen 模型及 deepseek-v4-pro、deepseek-v4-pro-0813、deepseek-v4-flash；目录未声明支持的模型会在本地直接拒绝。
        </p>
      </section>
