...
const models = [
  { id: "MiniMax-M2.5", context: "131K", input: 1.5, output: 6, desc: "M2.5 增强版，推理编程" },
  { id: "MiniMax-M2.1", context: "131K", input: 1, output: 4, desc: "M2.1 创意写作对话" },
];
    ...
    <div style={{ padding: "48px 64px", maxWidth: 1000 }}>
      <div style={{ marginBottom: 32 }}>
        ...
        <p style={{ fontSize: 15, color: "var(--text-secondary)", lineHeight: 1.8, maxWidth: 720, margin: 0 }}>
          MiniMax 系列模型，在创意写作和多轮对话方面表现突出。兼容 OpenAI SDK，统一走 Chat Completions 接口。
        </p>
      </div>
