...
const explicitModels = [
  ...
  { model: "qwen3-max", provider: "通义千问", minTokens: 1024 },
  { model: "qwen-plus", provider: "通义千问", minTokens: 1024 },
  { model: "qwen-flash", provider: "通义千问", minTokens: 1024 },
...
const implicitModels = [
  { model: "qwen3.8-max", provider: "通义千问", minTokens: "~256" },
  { model: "qwen3.7-max", provider: "通义千问", minTokens: "~2000" },
  { model: "qwen3.7-plus", provider: "通义千问", minTokens: "~2000" },
  { model: "qwen3.7-flash", provider: "通义千问", minTokens: "~2000" },
  { model: "qwen3-max", provider: "通义千问", minTokens: "~256" },
  ...
  { model: "qwen-flash", provider: "通义千问", minTokens: "~256" },
  ...
  { model: "glm-5.2", provider: "智谱AI", minTokens: "~256" },
  { model: "glm-5.2-fast-preview", provider: "智谱AI", minTokens: "~256" },
