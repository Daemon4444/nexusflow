...
const explicitModels = [
  ...
  { model: "glm-5.2", provider: "智谱AI", minTokens: 1024 },
  { model: "glm-5.2-fast-preview", provider: "智谱AI", minTokens: 1024 },
  { model: "glm-5.1", provider: "智谱AI", minTokens: 1024 },
  { model: "kimi/kimi-k3", provider: "月之暗面", minTokens: 1024 },
...
const implicitModels = [
  ...
  { model: "glm-5.2", provider: "智谱AI", minTokens: "~512" },
  { model: "glm-5.2-fast-preview", provider: "智谱AI", minTokens: "~512" },
