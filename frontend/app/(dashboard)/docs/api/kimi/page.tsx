...
const models = [
  { id: "kimi-k2.6", context: "262K", input: 6.5, output: 27, desc: "K2.6 flagship, long-context creative writing" },
  { id: "kimi-k2.5", context: "131K", input: 4, output: 21, desc: "K2.5 balanced model" },
];
...
const curlExample = `curl ${API_BASE}/v1/chat/completions \\
  ...
  -d '{
    "model": "kimi-k2.6",
    "messages": [
      {"role": "user", "content": "Help me condense this 3000-word article into a 300-word summary"}
    ],
    "stream": true
  }'`;
    ...
    <div style={{ padding: "48px 64px", maxWidth: 1000 }}>
      <div style={{ marginBottom: 32 }}>
        ...
        <p style={{ fontSize: 15, color: "var(--text-secondary)", lineHeight: 1.8, maxWidth: 720, margin: 0 }}>
          Moonshot's Kimi series of models, with strengths in long-context understanding, multi-turn dialog, and creative writing. Examples below default to OpenAI Chat Completions; the same model IDs can also be invoked via Anthropic Messages or Gemini-compatible protocols depending on per-model support.
        </p>
      </div>
