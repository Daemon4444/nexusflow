...
const requestParams: { name: string; type: string; required: boolean; desc: string }[] = [
  ...
  { name: "ratio", type: "string", required: false, desc: "Wan 文生视频支持 16:9（默认）、9:16、1:1；其他视频模型按各自说明。服务端会将 resolution + ratio 转换成精确 size。" },
  { name: "size", type: "string", required: false, desc: "Wan 可直接传精确尺寸，如 1280*720；兼容 1280x720 写法并自动规范化。与 resolution + ratio 二选一。" },
