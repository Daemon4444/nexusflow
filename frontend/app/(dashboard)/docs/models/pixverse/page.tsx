...
const models = [
  ["pixverse-v6", "Recommended", "Supports text-to-video and image-to-video."],
];
  ...
  return (
    <div style={{ padding: "48px 64px", maxWidth: 980 }}>
      <div style={{ marginBottom: 32 }}>
        <div style={{ fontSize: 12, color: "var(--text-tertiary)", marginBottom: 8, fontWeight: 600 }}>Model Overview</div>
        <h1 style={{ fontSize: 30, fontWeight: 700, color: "var(--text-primary)", margin: "0 0 10px" }}>
          PixVerse Video Models
        </h1>
        <p style={{ fontSize: 15, color: "var(--text-secondary)", lineHeight: 1.8, maxWidth: 720, margin: 0 }}>
          PixVerse models support text-to-video, image-to-video, and reference-to-video. The platform manages submission, polling, rate limiting, and result tracking through a unified task API.
        </p>
      </div>
      ...
      <section style={{ marginBottom: 36 }}>
        ...
        <div style={{ border: "1px solid var(--border)", borderRadius: 8, overflow: "hidden" }}>
          {[
            ...
            ["Reference-to-video", "reference_image_url + prompt + style control"],
          ].map(([name, desc], index) => (
