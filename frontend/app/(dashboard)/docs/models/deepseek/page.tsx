...
const deepseekModels = [
  ...
  },
  {
    ...
    desc: "高效轻量化 MoE 模型，总参 284B、激活 13B，原生支持百万超长上下文。推理速度快、延迟低、调用成本低，适合高并发与轻量化任务。",
    ctx: "1,000,000",
    maxOutput: "393,216",
    inputPrice: "¥1",
    outputPrice: "¥2",
    tags: ["V4", "极速", "高并发", "混合思考"],
    features: ["混合思考", "函数调用", "联网搜索", "上下文缓存"],
    isNew: true,
    isFeatured: true,
  },
  {
    ...
    desc: "V4 Flash 的新一代升级版。官方峰谷定价：忙时输入 ¥2/输出 ¥8、闲时输入 ¥1/输出 ¥4，NexusFlow 沿用 V4 Flash 平价口径按闲时价结算。",
    ctx: "1,000,000",
    maxOutput: "393,216",
    inputPrice: "¥1",
    outputPrice: "¥4",
    tags: ["V4.1", "极速", "高并发", "混合思考"],
    features: ["混合思考", "函数调用", "联网搜索", "上下文缓存"],
    isNew: true,
    isFeatured: true,
  },
  {
    ...
    desc: "V4 Flash 的 0731 固定快照，适合需要锁定行为和回归结果的生产任务。它与稳定版独立公开并同名直传百炼。",
    ctx: "1,000,000",
    maxOutput: "393,216",
    inputPrice: "¥1",
    outputPrice: "¥2",
    tags: ["V4", "0731", "固定快照", "混合思考"],
    features: ["混合思考", "函数调用", "联网搜索", "上下文缓存"],
    isNew: true,
    isFeatured: false,
  },
