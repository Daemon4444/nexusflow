...
const modelCategories = [
  ...
  },
  {
    ...
    desc: "五个稳定公共模型 ID 通过 HiModels AWS 原生 Anthropic Messages 兼容上游接入；同步和流式 /v1/messages 已验证",
