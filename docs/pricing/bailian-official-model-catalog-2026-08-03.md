<!-- 阿里云百炼官方模型价目/上下文/限流原始文档，用户于 2026-08-03T03:25:36.760Z 提供并确认为权威来源。
     原样存档，未做任何编辑。机器可比对的目录内模型值见 backend/scripts/verify-official-pricing.ts 的 REF 表。 -->
...
| 视频编辑与生成 | [文生视频](#7a13292788yvp) | [HappyHorse-文生视频](#dd6482805b1u3)、[万相-文生视频](#7a13292788yvp)：一句话生成视频，视频风格丰富，画质细腻。 更多模型：[爱诗-文生视频](#0f70069440fuf)、[Vidu-文生视频](#601c240fcd9nw)。 |
| [图生视频](#af6bc5a9c3cp9) | - [HappyHorse-首帧生视频](#47d90af2a333r)：以输入图像作为视频首帧，结合提示词生成完整视频。 - [万相-图生视频](#a9a94c5bf5794)：可完成首帧生视频、首尾帧生视频、视频续写三大任务。 - [首尾帧生视频](#90cb98a2b9s2q)：提供首帧与尾帧图像，结合提示词生成过渡自然的视频。 - [多图生视频](#f7de663db89xi)：支持输入一张或多张图片，参考图片中的主体或背景，并结合提示词生成视频。 - 图+动作模板生成舞蹈视频：[舞动人像AnimateAnyone](#a54957baf9exo)基于人物图片和动作视频生成舞蹈视频。 - 图+音频生成对口型视频 - [万相-数字人](#3bff5da885yx3)基于人物**图片**和音频，动作幅度大且自然，支持全身、半身、肖像等多种画幅，适合唱歌、表演等场景。 - [悦动人像EMO](#c6384886fd3s8)基于人物**图片**和音频，口型与表情表现力强，支持肖像、半身，适合人物特写场景。 - [灵动人像LivePortrait](#45109ade609nr)基于人物**图片**和音频，适合语音播报场景。 - 图+表情模板生成表情包视频：[表情包Emoji](#f62472e1b6m3b)基于人脸图片和预设的人脸动态模板，生成人脸表情包视频。 更多模型：[爱诗-图生视频-基于首帧](#62b5c1d4d6ijo)、[爱诗-图生视频-基于首尾帧](#4e4ebc10f7cvw)、[可灵-视频生成](#93251aa4ebi3q)、[Vidu-图生视频-基于首帧](#e9c949c200dw7)、[Vidu-图生视频-基于首尾帧](#ba9aa2e28dyq0)。 |
| [参考生视频](#62b53b525bud3) | - [HappyHorse-参考生视频](#8225027e37zyf)：参考图像，结合文本提示词生成视频。 - [万相-参考生视频](#62b53b525bud3)：参考输入视频或图像的角色形象，同时可参考视频中的音色，结合提示词生成表演视频。 更多模型：[爱诗-参考生视频](#0080eb1384z27)、 [可灵-视频生成](#93251aa4ebi3q)、[Vidu-参考生视频](#9e43ea149dw8k)。 |
| [视频编辑](#f7de663db89xi) | - [HappyHorse-视频编辑](#fab142641e7si)：对输入的视频进行指令和参考图编辑，实现风格转化、局部增删改等任务。 - [万相-视频编辑](#f7de663db89xi)：基于输入的文本提示词、图片和视频，可执行多种视频编辑任务。例如，通过提取输入视频的运动特征，并结合提示词生成新的视频。 - 视频口型替换：[声动人像VideoRetalk](#3714ddc2e6a0p)基于人物**视频**和音频，适合短视频制作、视频翻译等场景。 - 视频风格转换：[视频风格重绘](#21cd0ccad2ota)可将视频转换为日式漫画、美式漫画等风格。 更多模型：[可灵-视频生成](#93251aa4ebi3q)。 |
| 3D生成 | [3D生成](#ec31f28628rw1) | [Tripo-3D生成](#081a0e0aa45az)：支持文生3D、单图生3D和多图生3D。 |
...
| 视频编辑与生成 | [万相-文生视频](#7a13292788yvp) | - [万相-文生视频](#7a13292788yvp)：一句话生成视频，视频风格丰富，画质细腻。 |
| [图生视频](#af6bc5a9c3cp9) | [首帧生视频](#af6bc5a9c3cp9)：以输入图像作为视频首帧，结合提示词生成完整视频。 |
| [视频生视频](#62b53b525bud3) | [万相-参考生视频](#62b53b525bud3)：参考输入视频或图像的角色形象，同时可参考视频中的音色，结合提示词生成表演视频。 |
...
| 视频生成 | [文生视频](#7a13292788yvp) | [HappyHorse-文生视频](#dd6482805b1u3)、[万相-文生视频](#7a13292788yvp)：一句话生成视频，视频风格丰富，画质细腻。 |
| [图生视频](#af6bc5a9c3cp9) | - [HappyHorse-首帧生视频](#47d90af2a333r)：以输入图像作为视频首帧，结合提示词生成视频。 - [万相-图生视频](#a9a94c5bf5794)：可完成首帧生视频、首尾帧生视频、视频续写三大任务。 - [首帧生视频](#af6bc5a9c3cp9)：以输入图像作为视频首帧，结合提示词生成完整视频。 - [首尾帧生视频](#90cb98a2b9s2q)：提供首帧与尾帧图像，结合提示词生成过渡自然的视频。 - [多图生视频](#f7de663db89xi)：支持输入一张或多张图片，参考图片中的主体或背景，并结合提示词生成视频。 |
| [参考生视频](#62b53b525bud3) | - [HappyHorse-参考生视频](#8225027e37zyf)：参考图像，结合文本提示词生成视频。 - [万相-参考生视频](#62b53b525bud3)：参考输入视频或图像的角色形象，同时可参考视频中的音色，结合提示词生成表演视频。 |
| [视频编辑](#f7de663db89xi) | - [HappyHorse-视频编辑](#fab142641e7si)：对输入的视频进行指令和参考图编辑，实现风格转化、局部增删改等任务。 - [万相-视频编辑](#f7de663db89xi)：基于输入的文本提示词、图片和视频，可执行多种视频编辑任务。例如，通过提取输入视频的运动特征，并结合提示词生成新的视频。 |
| 向量  | [文本向量](#3383780daf8hw) | 将文本转换成一组可以代表文字的数字，用于搜索、聚类、推荐、分类等。 |
...
| 视频生成 | [万相-文生视频](#7a13292788yvp) | 一句话生成视频，视频风格丰富，画质细腻。 |
...
| --- | --- | --- | --- | --- | --- | --- |
| **（Token数）** |   |   |   | **（每百万 Token）** |   |
| deepseek-v4-pro > [上下文缓存](https://help.aliyun.com/zh/model-studio/context-cache)享有折扣 | 1,000,000 | 1,000,000 | 共 393,216 |   | 12元 | 24元 |
| deepseek-v4-flash > [上下文缓存](https://help.aliyun.com/zh/model-studio/context-cache)享有折扣 | 1元  | 2元  |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
|     | **（Token数）** |   |   |   | **（每百万 Token）** |   |
| kimi/kimi-k2.6 > [上下文缓存](https://help.aliyun.com/zh/model-studio/context-cache)享有折扣 | 思考模式 | 262,144 | 262,144 | 262,144 | 262,144 | 6.5元 | 27元 | 无   |
| 非思考模式 | \\- |
| kimi/kimi-k2.5 > [上下文缓存](https://help.aliyun.com/zh/model-studio/context-cache)享有折扣 | 思考模式 | 262,144 | 262,144 | 262,144 | 262,144 | 4元  | 21元 |
| 非思考模式 | \\- |
...
HappyHorse文生视频模型，输入文字即可生成高质量视频，支持多镜头叙事。[API参考](https://help.aliyun.com/zh/model-studio/happyhorse-text-to-video-api-reference)｜ [在线体验](https://bailian.console.aliyun.com/?spm=5176.30275541.J_ZGek9Blx07Hclc3Ddt9dg.4.51f82f3dFlj82T&scm=20140722.S_card%40%40%E4%BA%A7%E5%93%81%40%402983180.S_new%7EUND%7Ecard.ID_card%40%40%E4%BA%A7%E5%93%81%40%402983180-RL_%E7%99%BE%E7%82%BC%E5%B9%B3%E5%8F%B0-LOC_2024SPSearchCard-OR_ser-PAR1_215043cb17587857714454653ea60a-V_4-RE_new7-P0_0-P1_0&tab=demohouse#/experience/t2v)

计费规则：按成功生成的**视频秒数**计费，仅输出视频计费。失败不计费。
...
| **模型名称** | **说明** | **输出单价** | **免费额度** |
| --- | --- | --- | --- |
| happyhorse-1.0-t2v | HappyHorse文生视频模型。 | 720P：0.9元/秒 1080P：1.6元/秒 | 10秒 |
...
| **模型名称** | **说明** | **输出单价** | **免费额度** |
| --- | --- | --- | --- |
| happyhorse-1.0-t2v | HappyHorse文生视频模型。 | 720P：1.049188元/秒 1080P：1.798608元/秒 | 无免费额度 |

### HappyHorse**\-图生视频-基于首帧**

HappyHorse图生视频模型，以图像为首帧生成自然流畅的动态视频。[API参考](https://help.aliyun.com/zh/model-studio/happyhorse-image-to-video-api-reference)｜ [在线体验](https://bailian.console.aliyun.com/?spm=5176.30275541.J_ZGek9Blx07Hclc3Ddt9dg.4.51f82f3dFlj82T&scm=20140722.S_card%40%40%E4%BA%A7%E5%93%81%40%402983180.S_new%7EUND%7Ecard.ID_card%40%40%E4%BA%A7%E5%93%81%40%402983180-RL_%E7%99%BE%E7%82%BC%E5%B9%B3%E5%8F%B0-LOC_2024SPSearchCard-OR_ser-PAR1_215043cb17587857714454653ea60a-V_4-RE_new7-P0_0-P1_0&tab=demohouse#/experience/t2v)
...
| **模型名称** | **说明** | **输出单价** | **免费额度** |
| --- | --- | --- | --- |
| happyhorse-1.0-i2v | HappyHorse图生视频模型。 | 720P：0.9元/秒 1080P：1.6元/秒 | 10秒 |
...
| **模型名称** | **说明** | **输出单价** | **免费额度** |
| --- | --- | --- | --- |
| happyhorse-1.0-i2v | HappyHorse图生视频模型。 | 720P：1.049188元/秒 1080P：1.798608元/秒 | 无免费额度 |

### HappyHorse**\-参考生视频**

HappyHorse参考生视频模型，通过参考图片和文字描述生成高质量视频。[API参考](https://help.aliyun.com/zh/model-studio/happyhorse-image-to-video-api-reference)｜ [在线体验](https://bailian.console.aliyun.com/?spm=5176.30275541.J_ZGek9Blx07Hclc3Ddt9dg.4.51f82f3dFlj82T&scm=20140722.S_card%40%40%E4%BA%A7%E5%93%81%40%402983180.S_new%7EUND%7Ecard.ID_card%40%40%E4%BA%A7%E5%93%81%40%402983180-RL_%E7%99%BE%E7%82%BC%E5%B9%B3%E5%8F%B0-LOC_2024SPSearchCard-OR_ser-PAR1_215043cb17587857714454653ea60a-V_4-RE_new7-P0_0-P1_0&tab=demohouse#/experience/t2v)
...
| **模型名称** | **说明** | **输出单价** | **免费额度** |
| --- | --- | --- | --- |
| happyhorse-1.0-r2v | HappyHorse参考生视频模型。 | 720P：0.9元/秒 1080P：1.6元/秒 | 10秒 |
...
| **模型名称** | **说明** | **输出单价** | **免费额度** |
| --- | --- | --- | --- |
| happyhorse-1.0-r2v | HappyHorse参考生视频模型。 | 720P：1.049188元/秒 1080P：1.798608元/秒 | 无免费额度 |

### HappyHorse**\-视频编辑**

HappyHorse视频编辑模型，基于输入视频和参考图片进行视频编辑。 [API参考](https://help.aliyun.com/zh/model-studio/happyhorse-video-edit-api-reference)

计费规则：按**视频秒数**计费，输入视频和输出视频均计费。失败不计费。

## 中国内地

服务部署范围为[中国内地](https://help.aliyun.com/zh/model-studio/regions/#080da663a75xh)时，模型推理计算资源仅限于中国内地；静态数据存储于您所选的地域。该部署范围支持的地域：华北2（北京）。

| **模型名称** | **说明** | **输入和输出单价** | **免费额度** |
| --- | --- | --- | --- |
| happyhorse-1.0-video-edit | HappyHorse视频编辑模型。 | 720P：0.9元/秒 1080P：1.6元/秒 | 10秒 |
...
| **模型名称** | **说明** | **输入和输出单价** | **免费额度** |
| --- | --- | --- | --- |
| happyhorse-1.0-video-edit | HappyHorse视频编辑模型。 | 720P：1.049188元/秒 1080P：1.798608元/秒 | 无免费额度 |
...
| --- | --- | --- | --- |
| wan2.7-t2v-2026-04-25`**推荐**` | 万相2.7快照版本。通过提示词控制生成多镜头视频，支持自动配音和传入自定义音频文件。 | 720P：0.6元/秒 1080P：1元/秒 | 50秒 |
| wan2.7-t2v | 万相2.7。通过提示词控制生成多镜头视频，支持自动配音和传入自定义音频文件。 | 720P：0.6元/秒 1080P：1元/秒 | 50秒 |
...
| **模型名称** | **说明** | **单价** | **免费额度**[（注）](https://help.aliyun.com/zh/model-studio/new-free-quota) |
| --- | --- | --- | --- |
| wan2.7-t2v-2026-04-25`**推荐**` | 万相2.7快照版本。通过提示词控制生成多镜头视频，支持自动配音和传入自定义音频文件。 | 720P：0.733924元/秒 1080P：1.100886元/秒 | 无免费额度 |
| wan2.7-t2v | 万相2.7。通过提示词控制生成多镜头视频，支持自动配音和传入自定义音频文件。 | 720P：0.733924元/秒 1080P：1.100886元/秒 | 无免费额度 |
...
| **模型名称** | **说明** | **单价** | **免费额度**[（注）](https://help.aliyun.com/zh/model-studio/new-free-quota) 有效期：阿里云百炼开通后90天内 |
| --- | --- | --- | --- |
| wan2.7-i2v-2026-04-25`**推荐**` | 万相2.7快照版本。多任务模型，支持首帧生视频、首尾帧生视频、视频续写三大任务。 | 720P：0.6元/秒 1080P：1元/秒 | 50秒 |
| wan2.7-i2v | 万相2.7。多任务模型，支持首帧生视频、首尾帧生视频、视频续写三大任务。 | 720P：0.6元/秒 1080P：1元/秒 | 50秒 |
...
| **模型名称** | **说明** | **单价** | **免费额度**[（注）](https://help.aliyun.com/zh/model-studio/new-free-quota) |
| --- | --- | --- | --- |
| wan2.7-i2v-2026-04-25`**推荐**` | 万相2.7快照版本。多任务模型，支持首帧生视频、首尾帧生视频、视频续写三大任务。 | 720P：0.733924元/秒 1080P：1.100886元/秒 | 无免费额度 |
| wan2.7-i2v | 万相2.7。多任务模型，支持首帧生视频、首尾帧生视频、视频续写三大任务。 | 720P：0.733924元/秒 1080P：1.100886元/秒 | 无免费额度 |
...
-   计费公式：计费时长 = 输入视频时长（上限 5 秒）+ 输出视频时长。
    ...
    -   输入视频的计费时长不超过 **5 秒**，计算规则参见[万相2.7-参考生视频](https://help.aliyun.com/zh/model-studio/wan-video-to-video-api-reference#f79461ca408qn)。
...
| 720P | 0.25元/秒 |
| 1080P | 0.46875元/秒 |
| vidu/viduq2-pro-fast\\_img2video | 无声视频 | 720P | 0.1元/秒 |
| 1080P | 0.2元/秒 |
...
| **模型名称** | **支持的能力** | **输出视频分辨率** | **输出单价** | **免费额度**[（注）](https://help.aliyun.com/zh/model-studio/new-free-quota#591f3dfedfyzj) |
| --- | --- | --- | --- | --- |
| vidu/viduq3-mix\\_reference2video `**推荐**` | 有声视频、无声视频 | 720P | 0.78125元/秒 | 无免费额度 |
| 1080P | 0.9375元/秒 |
| vidu/viduq3\\_reference2video | 有声视频、无声视频 | 540P | 0.3125元/秒 |
| 720P | 0.625元/秒 |
| 1080P | 0.78125元/秒 |
| vidu/viduq3-turbo\\_reference2video | 有声视频、无声视频 | 540P | 0.15625元/秒 |
| 720P | 0.3125元/秒 |
| 1080P | 0.40625元/秒 |
| vidu/viduq2-pro\\_reference2video | 无声视频 > 支持参考图像和视频 | 540P | 0.25元/秒 |
| 720P | 0.3125元/秒 |
| 1080P | 0.78125元/秒 |
...
Tripo-3D生成支持文生3D、单图生3D和多图生3D。[API参考](https://help.aliyun.com/zh/model-studio/tripo-3d-generation-api-reference)
