...
-- Payment orders (third-party payment status tracking)
...
CREATE TABLE IF NOT EXISTS provider_models (
    ...
    name TEXT NOT NULL,
    description TEXT NOT NULL DEFAULT '',
    category TEXT NOT NULL DEFAULT 'Large Language Model',
...
-- Provider multi-channel configuration
...
-- Create triggers for tables that need automatic updated_at maintenance
DO $$
BEGIN
