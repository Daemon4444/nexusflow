...
const staticModels: AIModel[] = [
  ...
  },
  {
    ...
    name: "Qwen3.8 Flash",
    provider: "通义千问",
    description: "Qwen3.8 代多模态 Flash 模型，兼具强大的理解与生成能力和出色的响应速度。原生支持百万级上下文窗口，可一次性处理超长文档、代码仓库和复杂对话。编程辅助、智能体协作、图文理解场景表现突出，支持自动修复代码、操作桌面应用、分析图表与长视频。",
    contextLength: 1000000,
    promptPrice: 0.8,
    completionPrice: 2.7,
    tokenPricingTiers: [
      { label: "0<Token≤1M", maxTokens: 1000000, promptPrice: 0.8, completionPrice: 2.7, cacheReadPrice: 0.16, cacheReadExplicitPrice: 0.08 },
    ],
    category: "多模态模型",
    tags: ["极速", "低成本", "多模态", "视觉理解", "思考模式", "编程", "百万上下文"],
    isFeatured: true,
    isNew: true,
    maxOutput: 131072,
    supported: ["文本", "图像输入", "函数调用", "思考模式", "结构化输出", "批量推理", "上下文缓存"]
  },
  {
    id: "qwen3.7-plus",
    name: "Qwen3.7 Plus",
  ...
  },
  {
    ...
    name: "万相 2.7 文生图",
    provider: "通义千问",
    description: "万相 2.7 代文生图模型，图像质量与指令遵循能力进一步提升，支持中英文文本渲染与多种分辨率、宽高比输出。",
    contextLength: 4000,
    promptPrice: 0.2,
    completionPrice: 0,
    pricingType: "per-image",
    ...
    category: "图像生成",
    tags: ["图像生成", "文生图", "高清写实", "文字渲染"],
    isNew: true,
    maxOutput: 4,
    supported: ["文本到图像", "图文混排"]
  },
  {
    id: "wan2.7-image-pro",
    name: "万相 2.7 文生图 Pro",
    provider: "通义千问",
    description: "万相 2.7 代文生图旗舰版本，画面细节、复杂指令理解与图文混排质量更强，适合高质量创意与商业设计场景。",
    contextLength: 4000,
    promptPrice: 0.5,
    completionPrice: 0,
    pricingType: "per-image",
  ...
  },
  {
    ...
    name: "万相 2.7 文生视频",
    provider: "通义千问",
    description: "万相 2.7 代文生视频模型，画面质量、运动一致性与指令遵循显著提升，支持最长 50 秒 720P 视频生成与多镜头叙事。",
    contextLength: 1500,
    promptPrice: 0.6,
    completionPrice: 0,
    pricingType: "per-second",
  ...
  },
  {
    ...
    name: "万相 2.7 图生视频",
    provider: "通义千问",
    description: "万相 2.7 代图生视频模型，以输入图像作为首帧生成连贯视频，画面稳定性与运动自然度进一步提升，支持最长 50 秒 720P 输出。",
    contextLength: 1500,
    promptPrice: 0.6,
    completionPrice: 0,
    pricingType: "per-second",
    ...
    isNew: true,
    maxOutput: 50,
    supported: ["图生视频", "多镜头叙事"],
  },
  {
    id: "wan2.7-r2v",
    name: "万相 2.7 参考生视频",
    provider: "通义千问",
    description: "万相 2.7 代参考生视频模型，支持文本/图像/视频多模态参考输入，可将人物或物体作为主角生成长达 50 秒的表演视频。",
    contextLength: 1500,
    promptPrice: 0.6,
    completionPrice: 0,
    pricingType: "per-second",
  ...
  },
  {
    ...
    name: "万相 2.7 视频编辑",
    provider: "通义千问",
    description: "万相 2.7 代视频编辑模型，基于输入视频进行 AI 编辑与风格变换，支持参考图片辅助，编辑质量与一致性显著提升。",
    contextLength: 1500,
    promptPrice: 0.6,
    completionPrice: 0,
    pricingType: "per-second",
  ...
  },
  {
    ...
    name: "万相 3.0 视频生成",
    provider: "通义千问",
    description: "万相 3.0 代视频生成模型，支持文生/图生视频，480P 分辨率最长 30 秒。目录价 0.3 元/秒（官方限时 7 折活动价 0.21 元/秒，成本按目录原价结算）。",
    contextLength: 1500,
    promptPrice: 0.3,
    completionPrice: 0,
    pricingType: "per-second",
    pricingTiers: [
      { label: "480P", price: 0.3 },
    ],
    category: "视频生成",
    tags: ["视频生成", "新一代", "480P", "高性价比"],
    isNew: true,
    maxOutput: 30,
    supported: ["文生视频", "图生视频"],
  },
  {
    ...
    name: "万相 3.0 视频生成 Prime",
    provider: "通义千问",
    description: "万相 3.0 代旗舰视频生成模型，画面质量与运动表现领先，支持文生/图生视频，480P 分辨率最长 30 秒。",
    contextLength: 1500,
    promptPrice: 0.45,
    completionPrice: 0,
    pricingType: "per-second",
    pricingTiers: [
      { label: "480P", price: 0.45 },
    ],
    category: "视频生成",
    tags: ["视频生成", "旗舰", "480P", "新一代"],
    isNew: true,
    maxOutput: 30,
    supported: ["文生视频", "图生视频"],
  },
  ...
  },
  {
    ...
    provider: "阿里巴巴 (Alibaba)",
    description: "阿里巴巴 HappyHorse 1.1 代视频生成模型，文本生成高质量视频，480P 分辨率最长 10 秒，画面质量与指令遵循进一步提升。",
    contextLength: 2500,
    promptPrice: 0.45,
    completionPrice: 0,
    pricingType: "per-second",
  ...
  },
  {
    ...
    provider: "阿里巴巴 (Alibaba)",
    description: "HappyHorse 1.1 图生视频模型，以输入图片作为首帧生成连贯视频，480P 分辨率最长 10 秒，画面连贯性进一步提升。",
    contextLength: 2500,
    promptPrice: 0.45,
    completionPrice: 0,
    pricingType: "per-second",
  ...
  },
  {
    ...
    provider: "阿里巴巴 (Alibaba)",
    description: "HappyHorse 1.1 参考生视频模型，支持多张参考图片输入，将图中人物/物体/场景融合生成视频，480P 分辨率最长 10 秒。",
    contextLength: 2500,
    promptPrice: 0.45,
    completionPrice: 0,
    pricingType: "per-second",
  ...
  },
  {
    ...
    provider: "DeepSeek",
    description: "高效轻量化 MoE 模型，原生支持百万超长上下文，推理速度快、调用成本低。官方峰谷定价：忙时输入 2/输出 8，闲时输入 1/输出 4 元每百万 token；NexusFlow 沿用 V4 Flash 平价口径按闲时价结算。",
    contextLength: 1000000,
    promptPrice: 1,
    completionPrice: 4,
    cacheReadPrice: 0.2,
    category: "大语言模型",
    tags: ["V4.1", "极速", "高并发", "混合思考", "百万上下文"],
    isNew: true,
    maxOutput: 393216,
    defaultOutputReservation: 16384,
    supported: ["文本", "函数调用", "思考模式", "联网搜索", "上下文缓存"]
  ...
  // ========== Claude 模型家族 ==========
  {
    ...
    name: "Claude Opus 5",
    provider: "Anthropic",
    description: "Claude Opus 系列旗舰模型，面向复杂推理和长上下文任务。官方价格为 $5 输入 / $25 输出每百万 Token；这里按 1 USD≈¥6.8 折算。",
    contextLength: 1000000,
    promptPrice: 34,
    completionPrice: 170,
    cacheReadPrice: 3.4,
  ...
  },
  {
    ...
    provider: "Anthropic",
    description: "Claude Opus 系列高性能模型，适合复杂推理和长上下文工作流。官方价格为 $5 输入 / $25 输出每百万 Token；这里按 1 USD≈¥6.8 折算。",
    contextLength: 1000000,
    promptPrice: 34,
    completionPrice: 170,
    cacheReadPrice: 3.4,
  ...
  },
  {
    ...
    provider: "Anthropic",
    description: "Claude Sonnet 系列高性价比模型，适合生产级对话、代码和长上下文工作流。官方价格为 $2 输入 / $10 输出每百万 Token；这里按 1 USD≈¥6.8 折算。",
    contextLength: 1000000,
    promptPrice: 13.6,
    completionPrice: 68,
    cacheReadPrice: 1.36,
  ...
  },
  {
    ...
    provider: "Anthropic",
    description: "Claude Sonnet 系列均衡模型，适合生产级对话、代码和长上下文工作流。官方价格为 $3 输入 / $15 输出每百万 Token；这里按 1 USD≈¥6.8 折算。",
    contextLength: 1000000,
    promptPrice: 20.4,
    completionPrice: 102,
    cacheReadPrice: 2.04,
  ...
  },
  {
    ...
    provider: "Anthropic",
    description: "Claude Haiku 系列高速低成本模型，适合低延迟对话、分类、抽取和批量任务。官方价格为 $1 输入 / $5 输出每百万 Token；这里按 1 USD≈¥6.8 折算。",
  ...
  },
  {
    ...
    name: "GLM 5.3",
    provider: "智谱AI",
    description: "智谱AI GLM-5.3 新一代旗舰模型，支持 1M 无损超长上下文，提供三档深度思考调节，编程与复杂推理能力进一步增强，适用于长程智能体任务、复杂工程与企业级应用场景。",
    contextLength: 1048576,
    promptPrice: 8,
    completionPrice: 28,
    cacheReadPrice: 2,
    ...
    category: "大语言模型",
    tags: ["旗舰", "长上下文", "百万上下文", "编程", "深度思考", "智能体"],
    isFeatured: true,
    isNew: true,
    maxOutput: 131072,
    supported: ["文本", "函数调用", "思考模式", "结构化输出", "前缀续写", "批量推理", "上下文缓存"]
  ...
  },
  {
    ...
    name: "Kimi K2.7 Code",
    provider: "月之暗面",
    description: "月之暗面 Kimi K2.7 编程模型，支持文本、图片与视频输入，长程编程与智能体工具调用能力出色，适合代码生成、仓库级重构与自动化工程任务。",
    contextLength: 262144,
    promptPrice: 6.5,
    completionPrice: 27,
    cacheReadPrice: 1.3,
    cacheReadExplicitPrice: 0.65,
    category: "编程模型",
    tags: ["编程", "长程智能体", "视觉理解", "视频输入", "思考模式"],
    isNew: true,
    maxOutput: 98304,
    supported: ["文本", "图像输入", "视频输入", "函数调用", "思考模式", "结构化输出"]
  },
  {
    id: "kimi/kimi-k2.7-code-highspeed",
    name: "Kimi K2.7 Code 高速版",
    provider: "月之暗面",
    description: "Kimi K2.7 Code 的高速版本，模型能力对齐标准版，通过推理加速显著提升输出速度，适合 IDE 实时代码补全与高并发智能体调用场景。上游模型 id 为 kimi/kimi-k2.7-code-highspeed。",
    contextLength: 262144,
    promptPrice: 13,
    completionPrice: 54,
    cacheReadPrice: 2.6,
    cacheReadExplicitPrice: 1.3,
    category: "编程模型",
    tags: ["编程", "高速", "智能体", "思考模式"],
    isNew: true,
    maxOutput: 98304,
  ...
  },
  {
    ...
    provider: "月之暗面",
    description: "月之暗面 Agentic 思考模型，专为长程智能体任务设计，在深度推理、工具调用规划与复杂问题求解方面表现出色。",
    contextLength: 262144,
    promptPrice: 4,
    completionPrice: 16,
    cacheReadPrice: 0.8,
  ...
  },
  {
    ...
    name: "MiniMax M2.7",
    provider: "MiniMax",
    description: "MiniMax M2.7 新一代思考模型，推理与编程能力进一步提升，多轮对话与智能体工具调用更加稳定。仅支持思考模式输出。",
    contextLength: 196608,
    promptPrice: 2.1,
    completionPrice: 8.4,
    cacheReadPrice: 0.42,
    // 上游 apps/anthropic 不支持 MiniMax 思考系列，走平台内协议转换桥
    anthropicPassThrough: false,
    category: "推理模型",
    tags: ["推理", "编程", "思考链", "智能体"],
    isNew: true,
