...
const UNIT_REF: Record<string, UnitRef> = {
  ...
  "wan2.7-t2v": { pricingType: "per-second", base: 0.6, tiers: [{ label: "720P", price: 0.6 }] },
  "wan2.7-i2v": { pricingType: "per-second", base: 0.6, tiers: [{ label: "720P", price: 0.6 }] },
  "wan2.7-r2v": { pricingType: "per-second", base: 0.6, tiers: [{ label: "720P", price: 0.6 }] },
  "wan2.7-videoedit": { pricingType: "per-second", base: 0.6, tiers: [{ label: "720P", price: 0.6 }] },
